...
namespace Dungeons
{
    public class Field
    {
        ...
        public static readonly Field Floor = new Field { Name = "Floor", FontType = FontType.BaseFont, ForeColor = Color.FromArgb(198, 155, 1), Y = 57, StartX = 78 };
        public static readonly Field RedFloor = new Field { Name = "Floor", FontType = FontType.BaseFont, ForeColor = Color.FromArgb(160, 0, 0), Y = 57, StartX = 78 };
        public static readonly Field FloorXP = new Field { Name = "FloorXP", FontType = FontType.BaseFont, ForeColor = Color.FromArgb(226, 226, 162), Y = 71, StartX = 47 };
        public static readonly Field PrestigeXP = new Field { Name = "PrestigeXP", FontType = FontType.BaseFont, ForeColor = Color.FromArgb(226, 226, 162), Y = 71, StartX = 147 };
        public static readonly Field AverageBaseXP = new Field { Name = "BaseXP", FontType = FontType.BaseFont, ForeColor = Color.FromArgb(226, 226, 162), Y = 71, StartX = 247 };
